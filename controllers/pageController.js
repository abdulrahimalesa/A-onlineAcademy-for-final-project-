...
exports.getAboutPage =  (req, res) => {
  ...
  exports.getWorkWithUs =  (req, res) => {
    res.status(200).render('work-with-us',{
        page_name: 'work-with-us'
    });
  };
  
  exports.getTeacherOnayla = async (req, res) => {
    const teacherRegister = await TeacherRegister.findById({_id: req.params.id}).sort('-createAt');
    res.status(200).render('teacher-onayla',{
        page_name: 'teacher-onayla',
        teacherRegister
